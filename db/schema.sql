...
INSERT INTO role (title, salary, department_id) VALUE ("Accountant Lead", 95000, 3);
...
INSERT INTO role (title, salary, department_id) VALUE ("Accountant", 75000,3);
...
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUE ("Tony", "Stark", null, 4);
...
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUE ("Pepper", "Potts", 3, 8);
